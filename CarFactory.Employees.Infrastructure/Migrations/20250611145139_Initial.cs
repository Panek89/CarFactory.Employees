        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    EMPLOYEE_REQUEST_ID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EMPLOYEE_REQUEST_CANIDATES_EMPLOYEE_REQUESTS_EMPLOYEE_REQUEST_ID",
                        column: x => x.EMPLOYEE_REQUEST_ID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EMPLOYEE_REQUEST_CANIDATES_EMPLOYEE_REQUEST_ID",
                table: "EMPLOYEE_REQUEST_CANIDATES",
                column: "EMPLOYEE_REQUEST_ID");
        }
